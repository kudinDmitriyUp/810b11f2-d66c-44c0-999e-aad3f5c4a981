...
export const metadata: Metadata = {
  title: "Vintage Volumes - Rare & Vintage Books Las Vegas",
  description: "Las Vegas premier vintage bookstore since 1985. Rare books, first editions, manuscripts, professional appraisals & authentication services.",
  keywords: "vintage books Las Vegas, rare books Nevada, first editions, book appraisal, antique books, manuscript authentication, book restoration",
  metadataBase: new URL("https://vintagevolumes.com"),
  alternates: {
    canonical: "https://vintagevolumes.com"
  },
  openGraph: {
    title: "Vintage Volumes - Rare & Vintage Books Las Vegas",
    description: "Discover treasured literary gems from bygone eras. Professional book services since 1985.",
    url: "https://vintagevolumes.com",
    siteName: "Vintage Volumes",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763238908631-tqkc6s06.jpg",
  ...
  twitter: {
    ...
    title: "Vintage Volumes - Rare & Vintage Books Las Vegas",
    description: "Las Vegas premier vintage bookstore since 1985",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763238908631-tqkc6s06.jpg"]
  },
  robots: {
    index: true,
    follow: true
